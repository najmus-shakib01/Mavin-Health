// features/MedicalAssistant/AssistantTab.jsx (আপডেটেড)
...
const AssistantTab = ({
    ...
    // Check if response contains specialist recommendation
        ...
        <div>
            ...
            <div className="mt-5 flex gap-2 items-end">
                <div className="flex-1 relative">
                    <textarea ref={textareaRef} id="userInput" placeholder={isEnglish ? "Describe your health issue in detail to get a proper answer..." : "صف مشكلتك الصحية بالتفصيل للحصول على إجابة مناسبة..."} rows={1} autoFocus className="w-full text-base border border-gray-300 dark:bg-gray-800 dark:border-gray-600 shadow-sm rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none leading-relaxed max-h-40 overflow-y-auto pr-12" aria-label={isEnglish ? "Type your health question here..." : "اكتب سؤالك الصحي هنا..."} value={userInput} onChange={(e) => setUserInput(e.target.value)} onInput={autoResizeTextarea} onKeyDown={handleKeyDown}
                    ></textarea>
                </div>
