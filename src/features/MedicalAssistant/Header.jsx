            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0">
                ...
                <div className="flex items-center gap-2 md:gap-4">
                    ...
                    <button
                        ...
                        className="p-1.5 md:p-2 text-white bg-blue-600 dark:bg-blue-400 rounded-full transition-colors"
                        aria-label={darkMode ? "Switch to light mode" : "Switch to dark mode"}
                    >
                        {darkMode ? (
                            <Sun size={18} className="w-4 h-4 md:w-5 md:h-5" />
                        ) : (
                            <Moon size={18} className="w-4 h-4 md:w-5 md:h-5" />
                        )}
                    </button>
                </div>
            </div>
