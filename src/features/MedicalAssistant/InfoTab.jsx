const InfoTab = () => {
    return (
        <div className="min-h-[300px]">
            <h3 className="font-medium text-gray-900 mb-4 pl-5">Health Information Resources</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-5">

                <div className="bg-blue-50 p-5 rounded-lg border border-blue-200">
                    <h4 className="font-medium text-blue-800 mb-2">Common Symptoms Guide</h4>
                ...
                <div className="bg-emerald-50 p-4 rounded-lg border border-emerald-200">
                    <h4 className="font-medium text-emerald-800 mb-2">When to Seek Emergency Care</h4>
                ...
                <div className="bg-amber-50 p-4 rounded-lg border border-amber-200">
                    <h4 className="font-medium text-amber-800 mb-2">Disclaimer</h4>
                ...
                <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
                    <h4 className="font-medium text-purple-800 mb-2">Data Privacy</h4>
