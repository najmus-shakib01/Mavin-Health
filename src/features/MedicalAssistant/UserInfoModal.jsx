            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl max-w-md w-full p-6">
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <input type="number" value={age} onChange={(e) => setAge(e.target.value)} className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white" placeholder={isEnglish ? "Enter your age" : "أدخل عمرك"} min="1" max="120" />
                    </div>
